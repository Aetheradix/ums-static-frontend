...
export const menuConfig: Menu.MenuItem[] = [
  {
    ...
    colorScheme: 'teal',
    description:
      'Hostel registration, room configuration and allotment, admissions from a public forum, and the day-to-day running of every hostel.',
    ...
    children: [
        ...
        children: [
          {
            ...
            path: '/hostel-management-system/admin/dashboard',
            icon: 'dashboard',
            colorScheme: 'teal',
          },
          {
            label: 'Hostel Registration',
            slug: 'hms-hostel-registration',
            description:
              'Register a hostel with its location, capacity and warden — credentials are issued on registration.',
          ...
          },
          {
            ...
            slug: 'hms-monitoring',
            description:
              'Hostel-wise seats configured, allotted and remaining.',
            path: '/hostel-management-system/admin/monitoring',
            icon: 'monitoring',
            colorScheme: 'indigo',
          },
          {
            ...
            path: '/hostel-management-system/admin/reports',
            icon: 'bar_chart',
            colorScheme: 'purple',
          },
        ],
      },
      {
        ...
        children: [
          {
            label: 'Dashboard',
            slug: 'hms-warden-dashboard',
            path: '/hostel-management-system/warden/dashboard',
            icon: 'dashboard',
            colorScheme: 'teal',
          },
          {
            label: 'Room Configuration',
            slug: 'hms-room-configuration',
            description:
              'Declare room counts by type, then record every room number with its floor and wing.',
            path: '/hostel-management-system/warden/room-configuration',
            icon: 'meeting_room',
            colorScheme: 'blue',
          },
          {
            ...
            slug: 'hms-facilities',
            path: '/hostel-management-system/warden/facilities',
            icon: 'checklist',
            colorScheme: 'green',
          },
          {
          ...
          },
          {
            ...
            slug: 'hms-room-allocation',
            description:
              'Allot a room by type and number, with the free beds shown against each room.',
            path: '/hostel-management-system/warden/room-allocation',
            icon: 'bed',
            colorScheme: 'pink',
          },
          {
            label: 'Daily Attendance',
            slug: 'hms-warden-attendance',
            path: '/hostel-management-system/warden/attendance',
            icon: 'event_available',
            colorScheme: 'purple',
          },
          {
            label: 'In & Out Entry',
            slug: 'hms-warden-in-out',
            path: '/hostel-management-system/warden/in-out-entry',
            icon: 'swap_horiz',
            colorScheme: 'teal',
          },
          {
            label: 'Leave Requests',
            slug: 'hms-warden-leave',
            path: '/hostel-management-system/warden/leave-requests',
            icon: 'directions_walk',
            colorScheme: 'blue',
          },
          {
            label: 'Visitor Entry',
            slug: 'hms-warden-visitors',
            path: '/hostel-management-system/warden/visitors',
            icon: 'group',
            colorScheme: 'pink',
          },
          {
            label: 'Student Warnings',
            slug: 'hms-warden-warnings',
            path: '/hostel-management-system/warden/warnings',
            icon: 'warning',
            colorScheme: 'amber',
          },
          {
            label: 'Mess Menu',
            slug: 'hms-warden-mess-menu',
            path: '/hostel-management-system/warden/mess-menu',
            icon: 'restaurant_menu',
            colorScheme: 'green',
          },
          {
            label: 'Mess Feedback',
            slug: 'hms-warden-mess-feedback',
            path: '/hostel-management-system/warden/mess-feedback',
            icon: 'rate_review',
            colorScheme: 'orange',
          },
          {
            label: 'Fee & Payments',
            slug: 'hms-warden-payments',
            path: '/hostel-management-system/warden/payments',
            icon: 'payments',
            colorScheme: 'green',
          },
          {
            label: 'Curricular Activities',
            slug: 'hms-warden-activities',
            path: '/hostel-management-system/warden/activities',
            icon: 'sports_soccer',
            colorScheme: 'purple',
          },
          {
            label: 'Room Change Requests',
            slug: 'hms-warden-room-change',
            path: '/hostel-management-system/warden/room-change-requests',
            icon: 'swap_calls',
            colorScheme: 'indigo',
          },
          {
            label: 'Grievances',
            slug: 'hms-warden-grievances',
            path: '/hostel-management-system/warden/grievances',
            icon: 'flag',
            colorScheme: 'red',
          },
        ],
      },
      {
        ...
        path: '/hostel-management-system/student',
        icon: 'school',
        colorScheme: 'blue',
        children: [
          {
            label: 'Dashboard',
            slug: 'hms-student-dashboard',
            path: '/hostel-management-system/student/dashboard',
            icon: 'dashboard',
            colorScheme: 'teal',
          },
          {
            label: 'My Room',
            slug: 'hms-my-room',
            path: '/hostel-management-system/student/my-room',
            icon: 'bed',
            colorScheme: 'indigo',
          },
          {
            label: 'Fee & Payments',
            slug: 'hms-student-payments',
            description:
              'Pay the hostel fee, caution money and mess charges, and download receipts.',
            path: '/hostel-management-system/student/payments',
            icon: 'payments',
            colorScheme: 'green',
          },
          {
            label: 'My Attendance',
            slug: 'hms-student-attendance',
            path: '/hostel-management-system/student/attendance',
            icon: 'event_available',
            colorScheme: 'purple',
          },
          {
            label: 'In & Out Entry',
            slug: 'hms-student-in-out',
            path: '/hostel-management-system/student/in-out-entry',
            icon: 'swap_horiz',
            colorScheme: 'teal',
          },
          {
            label: 'Leave Application',
            slug: 'hms-student-leave',
            description:
              'Apply for leave — your parent is notified and confirms with an OTP before the warden sees it.',
            path: '/hostel-management-system/student/leave-requests',
            icon: 'directions_walk',
            colorScheme: 'blue',
          },
          {
            label: 'My Visitors',
            slug: 'hms-student-visitors',
            path: '/hostel-management-system/student/visitors',
            icon: 'group',
            colorScheme: 'pink',
          },
          {
            label: 'My Warnings',
            slug: 'hms-student-warnings',
            path: '/hostel-management-system/student/warnings',
            icon: 'warning',
            colorScheme: 'amber',
          },
          {
            label: 'Mess Menu',
            slug: 'hms-student-mess-menu',
            path: '/hostel-management-system/student/mess-menu',
            icon: 'restaurant_menu',
            colorScheme: 'green',
          },
          {
            label: 'Mess Feedback',
            slug: 'hms-student-mess-feedback',
            path: '/hostel-management-system/student/mess-feedback',
            icon: 'rate_review',
            colorScheme: 'orange',
          },
          {
            label: 'Curricular Activities',
            slug: 'hms-student-activities',
            path: '/hostel-management-system/student/activities',
            icon: 'sports_soccer',
            colorScheme: 'purple',
          },
          {
            label: 'Room Change Request',
            slug: 'hms-student-room-change',
            path: '/hostel-management-system/student/room-change-request',
            icon: 'swap_calls',
            colorScheme: 'indigo',
          },
          {
            label: 'Grievances',
            slug: 'hms-student-grievances',
            path: '/hostel-management-system/student/grievances',
            icon: 'flag',
            colorScheme: 'red',
          },
        ],
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        category: 'Hostel',
        description:
          'University hostel administration — masters, stock, applications and reports.',
        ...
        children: [
          {
            ...
            slug: 'hostel-employee-portal',
            description: 'Hostel staff and warden entry point.',
            path: '/hostel-management/employee',
            icon: 'badge',
            colorScheme: 'green',
            navigationStyle: 'sidebar',
            children: [
              {
                ...
                slug: 'employee-dashboards',
                description: 'View warden dashboard and metrics.',
              ...
              },
              {
                ...
                slug: 'employee-student-ops',
                description: 'Manage gate passes, leaves, and discipline.',
                ...
                children: [
                  {
                    ...
                    slug: 'emp-gate-pass-approval',
                    description: 'Approve or reject student gate passes.',
                    path: '/hostel-management/student-operations/gate-pass-approval',
                    icon: 'approval',
                    colorScheme: 'green',
                    feature: '@hostel/student-operations/gate-pass-approval',
                    action: 'write',
                  },
                  {
                    label: 'Leave Approval',
                    slug: 'emp-leave-approval',
                    description: 'Approve or reject student leave requests.',
                    path: '/hostel-management/student-operations/leave-approval',
                    icon: 'event_available',
                    colorScheme: 'blue',
                    feature: '@hostel/student-operations/leave-approval',
                    action: 'write',
                  },
                  {
                    label: 'Attendance Marking',
                    slug: 'emp-attendance-marking',
                    description: 'Mark student attendance in hostel.',
                    path: '/hostel-management/student-operations/attendance-marking',
                    icon: 'co_present',
                    colorScheme: 'purple',
                    feature: '@hostel/student-operations/attendance-marking',
                    action: 'write',
                  },
                  {
                    label: 'Visitor Logbook',
                    slug: 'emp-visitor-logbook',
                    description: 'Log visitors and their details.',
                    path: '/hostel-management/student-operations/visitor-logbook',
                    icon: 'badge',
                    colorScheme: 'orange',
                    feature: '@hostel/student-operations/visitor-logbook',
                    action: 'write',
                  },
                  {
                    label: 'Disciplinary Action',
                    slug: 'emp-disciplinary-action',
                    description:
                      'Record disciplinary actions against students.',
                    path: '/hostel-management/student-operations/disciplinary-action',
                    icon: 'gavel',
                    colorScheme: 'red',
                    feature: '@hostel/student-operations/disciplinary-action',
                    action: 'write',
                  },
                  {
                    label: 'Incident Reporting',
                    slug: 'emp-incident-reporting',
                    description: 'Report and manage hostel incidents.',
                    path: '/hostel-management/student-operations/incident-reporting',
                    icon: 'report_problem',
                    colorScheme: 'orange',
                    feature: '@hostel/student-operations/incident-reporting',
                    action: 'write',
                  },
                ],
              },
              {
                label: 'Health & Mess',
                slug: 'employee-health-mess',
                description: 'Track meal attendance and medical emergencies.',
                ...
                children: [
                  {
                    label: 'Emergency Log',
                    slug: 'emp-emergency-log',
                    description: 'Log medical emergencies.',
                    path: '/hostel-management/health/emergency-log',
                    icon: 'local_hospital',
                    colorScheme: 'red',
                    feature: '@hostel/health/emergency-log',
                    action: 'write',
                  },
                  {
                    label: 'Sick Diet',
                    slug: 'emp-sick-diet',
                    description: 'Manage sick diet requests.',
                    path: '/hostel-management/health/sick-diet',
                    icon: 'soup_kitchen',
                    colorScheme: 'orange',
                    feature: '@hostel/health/sick-diet',
                    action: 'write',
                  },
                  {
                    label: 'First Aid',
                    slug: 'emp-first-aid',
                    description: 'First aid and primary care log.',
                    path: '/hostel-management/health/first-aid',
                    icon: 'medical_services',
                    colorScheme: 'blue',
                    feature: '@hostel/health/first-aid',
                    action: 'write',
                  },
                  {
                    label: 'Meal Attendance',
                    slug: 'emp-meal-attendance',
                    description: 'Track student meal attendance.',
                    path: '/hostel-management/health/meal-attendance',
                    icon: 'fact_check',
                    colorScheme: 'green',
                    feature: '@hostel/health/meal-attendance',
                    action: 'write',
                  },
                  {
                    label: 'Mess Feedback',
                    slug: 'emp-mess-feedback',
                    description: 'View mess feedback from students.',
                    path: '/hostel-management/health/mess-feedback',
                    icon: 'feedback',
                    colorScheme: 'purple',
                    feature: '@hostel/health/mess-feedback',
                    action: 'read',
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    label: 'Maintenance Assignment',
                    slug: 'emp-maintenance-assignment',
                    description: 'Assign tasks to maintenance staff.',
                    path: '/hostel-management/maintenance/assignment',
                    icon: 'assignment_ind',
                    colorScheme: 'blue',
                    feature: '@hostel/maintenance/assignment',
                    action: 'write',
                  },
                  {
                    label: 'Maintenance Status',
                    slug: 'emp-maintenance-status',
                    description: 'Track status of maintenance requests.',
                    path: '/hostel-management/maintenance/status',
                    icon: 'timeline',
                    colorScheme: 'green',
                    feature: '@hostel/maintenance/status',
                    action: 'write',
                  },
                ],
              },
              {
                ...
                slug: 'employee-stock',
                description: 'Issue items and log damages.',
                ...
                children: [
                  {
                    label: 'Issue Stock',
                    slug: 'emp-stock-issue',
                    description: 'Issue stock items to students or staff.',
                    path: '/hostel-management/stock/issue',
                    icon: 'outbox',
                    colorScheme: 'blue',
                    feature: '@hostel/stock/issue',
                    action: 'write',
                  },
                  {
                    label: 'Damage & Scrap',
                    slug: 'emp-damage-scrap',
                    description: 'Record damaged or scrapped items.',
                    path: '/hostel-management/stock/damage-scrap',
                    icon: 'delete_sweep',
                    colorScheme: 'red',
                    feature: '@hostel/stock/damage-scrap',
                    action: 'write',
                  },
                  {
                    label: 'Room Audit',
                    slug: 'emp-room-audit',
                    description: 'Audit room assets.',
                    path: '/hostel-management/stock/room-audit',
                    icon: 'fact_check',
                    colorScheme: 'green',
                    feature: '@hostel/stock/room-audit',
                    action: 'write',
                  },
                ],
              },
          ...
          {
            label: 'Admin Portal',
            slug: 'hostel-admin-portal',
            description:
              'Hostel admin entry point — masters, reports, stock and student applications.',
            path: '/hostel-management/admin',
            icon: 'admin_panel_settings',
            colorScheme: 'blue',
            navigationStyle: 'sidebar',
            children: [
              {
                label: 'Masters',
                slug: 'hostel-masters',
                description: 'Hostel configuration masters.',
                path: '/hostel-management/masters/basic-facility',
                icon: 'settings',
                colorScheme: 'blue',
                navigationStyle: 'sidebar',
                children: [
                  {
                    label: 'New Hostel Registration',
                    slug: 'new-hostel-registration',
                    description: 'Register a new hostel entity.',
                    path: '/hostel-management/masters/new-hostel-registration',
                    icon: 'apartment',
                    colorScheme: 'green',
                    feature: '@hostel/masters/new-hostel-registration',
                    action: 'write',
                  },
                  {
                    ...
                    description:
                      'Configure hostel building layout (floors, rooms).',
                    path: '/hostel-management/masters/building-layout',
                    icon: 'business',
                    colorScheme: 'purple',
                    feature: '@hostel/masters/building-layout',
                    action: 'write',
                  },
                  {
                    label: 'Basic Facility',
                    slug: 'basic-facility',
                    description: 'Manage basic amenities available in hostels.',
                    path: '/hostel-management/masters/basic-facility',
                    icon: 'checklist',
                    colorScheme: 'blue',
                    feature: '@hostel/masters/basic-facility',
                    action: 'read',
                  },
                  {
                    label: 'Shift Master',
                    slug: 'shift-master',
                    description: 'Define hostel staff operating shifts.',
                    path: '/hostel-management/masters/shift-master',
                    icon: 'schedule',
                    colorScheme: 'purple',
                    feature: '@hostel/masters/shift-master',
                    action: 'write',
                  },
                  {
                    label: 'Item Category',
                    slug: 'item-category',
                    description: 'Define inventory item categories.',
                    path: '/hostel-management/masters/item-category',
                    icon: 'category',
                    colorScheme: 'teal',
                    feature: '@hostel/masters/item-category',
                    action: 'write',
                  },
                  {
                    label: 'Item Master',
                    slug: 'item-master',
                    description: 'Manage the hostel inventory catalog.',
                    path: '/hostel-management/masters/item-master',
                    icon: 'inventory_2',
                    colorScheme: 'red',
                    feature: '@hostel/masters/item-master',
                    action: 'write',
                  },
                  {
                    label: 'Room Type Master',
                    slug: 'room-type-master',
                    description: 'Configure accommodation room types.',
                    path: '/hostel-management/masters/room-type-master',
                    icon: 'king_bed',
                    colorScheme: 'indigo',
                    feature: '@hostel/masters/room-type-master',
                    action: 'write',
                  },
                  {
                    label: 'Room Asset Checklist',
                    slug: 'room-asset-checklist',
                    description: 'Configure default assets per room type.',
                    path: '/hostel-management/masters/room-asset-checklist',
                    icon: 'format_list_bulleted',
                    colorScheme: 'green',
                    feature: '@hostel/masters/room-asset-checklist',
                    action: 'write',
                  },
                  {
                    label: 'Mess Menu',
                    slug: 'mess-menu',
                    description: 'Configure daily mess menus.',
                    path: '/hostel-management/masters/mess-menu',
                    icon: 'restaurant_menu',
                    colorScheme: 'orange',
                    feature: '@hostel/masters/mess-menu',
                    action: 'write',
                  },
                ],
              },
              {
                ...
                slug: 'hostel-room-management',
                description: 'Room allocations and changes.',
                ...
                children: [
                  {
                    label: 'Allotment Config',
                    slug: 'allotment-config',
                    description: 'Configure allotment rules.',
                    path: '/hostel-management/room-management/allotment-config',
                    icon: 'settings_suggest',
                    colorScheme: 'blue',
                    feature: '@hostel/room-management/allotment-config',
                    action: 'write',
                  },
                  {
                    label: 'Single Allotment',
                    slug: 'single-allotment',
                    description: 'Allot a single room to a student.',
                    path: '/hostel-management/room-management/single-allotment',
                    icon: 'person_add',
                    colorScheme: 'green',
                    feature: '@hostel/room-management/single-allotment',
                    action: 'write',
                  },
                  {
                    label: 'Bulk Allotment',
                    slug: 'bulk-allotment',
                    description: 'Allot rooms in bulk.',
                    path: '/hostel-management/room-management/bulk-allotment',
                    icon: 'group_add',
                    colorScheme: 'purple',
                    feature: '@hostel/room-management/bulk-allotment',
                    action: 'write',
                  },
                  {
                    label: 'Allotment Roster',
                    slug: 'allotment-roster',
                    description: 'View current allotment roster.',
                    path: '/hostel-management/room-management/allotment-roster',
                    icon: 'view_list',
                    colorScheme: 'orange',
                    feature: '@hostel/room-management/allotment-roster',
                    action: 'read',
                  },
                  {
                    label: 'Check-In List',
                    slug: 'check-in-list',
                    description: 'View students pending check-in.',
                    path: '/hostel-management/room-management/check-in-list',
                    icon: 'how_to_reg',
                    colorScheme: 'teal',
                    feature: '@hostel/room-management/check-in-list',
                    action: 'read',
                  },
                  {
                    label: 'Room Change Approval',
                    slug: 'room-change-approval',
                    description: 'Approve or reject room change requests.',
                    path: '/hostel-management/room-management/room-change-approval',
                    icon: 'sync_alt',
                    colorScheme: 'red',
                    feature: '@hostel/room-management/room-change-approval',
                    action: 'write',
                  },
                ],
              },
              {
                label: 'Stock Report & Management',
                slug: 'hostel-stock-report',
                description: 'Hostel inventory stock management and reports.',
                path: '/hostel-management/stock-report/stock-report',
                icon: 'inventory_2',
                colorScheme: 'green',
                navigationStyle: 'sidebar',
                children: [
                  {
                    ...
                    slug: 'stock-procurement',
                    description: 'Inward stock / purchase records.',
                    path: '/hostel-management/stock/procurement',
                    icon: 'local_shipping',
                    colorScheme: 'purple',
                    feature: '@hostel/stock/procurement',
                    action: 'write',
                  },
                  {
                    label: 'Low Stock Report',
                    slug: 'low-stock-report',
                    description: 'View items below reorder level.',
                    path: '/hostel-management/stock/low-stock',
                    icon: 'warning',
                    colorScheme: 'red',
                    feature: '@hostel/stock/low-stock',
                    action: 'read',
                  },
                  {
                    label: 'Vendors',
                    slug: 'vendors',
                    description: 'Manage stock vendors.',
                    path: '/hostel-management/stock/vendors',
                    icon: 'storefront',
                    colorScheme: 'blue',
                    feature: '@hostel/stock/vendors',
                    action: 'write',
                  },
                  {
                    ...
                    path: '/hostel-management/stock/purchase-order',
                    icon: 'receipt_long',
                    colorScheme: 'green',
                    feature: '@hostel/stock/purchase-order',
                    action: 'write',
                  },
                  {
                    label: 'Stock Overview Report',
                    slug: 'stock-report',
                    description: 'Current inventory levels per hostel.',
                    path: '/hostel-management/stock-report/stock-report',
                    icon: 'inventory',
                    colorScheme: 'blue',
                    feature: '@hostel/stock-report/stock-report',
                    action: 'read',
                  },
                ],
              },
              {
                ...
                description: 'Hostel student application processing.',
                ...
                children: [
                  {
                    ...
                    description: 'Search and view application status history.',
                    path: '/hostel-management/student-application/status',
                    icon: 'history',
                    colorScheme: 'blue',
                    feature: '@hostel/applications/application-status-history',
                    action: 'read',
                  },
                  {
                    label: 'Scrutiny Process',
                    slug: 'scrutiny-process',
                    description: 'Scrutinise pending hostel applications.',
                    path: '/hostel-management/student-application/scrutiny-list',
                    icon: 'fact_check',
                    colorScheme: 'purple',
                    feature: '@hostel/applications/scrutiny-process',
                    action: 'write',
                  },
                  {
                    label: 'Apply for Hostel',
                    slug: 'apply-for-hostel',
                    description: 'Submit a new hostel application.',
                    path: '/hostel-management/student-application/apply',
                    icon: 'lock',
                    colorScheme: 'red',
                    feature: '@hostel/applications/lock-student-profile',
                    action: 'write',
                  },
                ],
              },
              {
                ...
                slug: 'hostel-staff-management',
                description: 'Hostel staff operations.',
                ...
                children: [
                  {
                    ...
                    description: 'Register new hostel staff.',
                    path: '/hostel-management/staff/registration',
                    icon: 'person_add',
                    colorScheme: 'blue',
                    feature: '@hostel/staff/registration',
                    action: 'write',
                  },
                  {
                    label: 'Staff Shifts',
                    slug: 'staff-shifts',
                    description: 'Assign shifts to staff.',
                    path: '/hostel-management/staff/shifts',
                    icon: 'schedule',
                    colorScheme: 'green',
                    feature: '@hostel/staff/shifts',
                    action: 'write',
                  },
                  {
                    ...
                    path: '/hostel-management/staff/attendance',
                    icon: 'how_to_reg',
                    colorScheme: 'purple',
                    feature: '@hostel/staff/attendance',
                    action: 'write',
                  },
                ],
              },
              {
                label: 'Reports',
                slug: 'hostel-reports',
                description: 'Hostel operational reports.',
                ...
                children: [
                  {
                    label: 'Admin Dashboard',
                    slug: 'admin-dashboard',
                    description: 'High level administrative overview.',
                    path: '/hostel-management/reports/admin-dashboard',
                    icon: 'dashboard',
                    colorScheme: 'blue',
                    feature: '@hostel/reports/admin-dashboard',
                    action: 'read',
                  },
                  {
                    label: 'Revenue Report',
                    slug: 'revenue-report',
                    description: 'Financial revenue from hostels.',
                    path: '/hostel-management/reports/revenue',
                    icon: 'attach_money',
                    colorScheme: 'green',
                    feature: '@hostel/reports/revenue',
                    action: 'read',
                  },
                  {
                    label: 'Occupancy Report',
                    slug: 'occupancy-report',
                    description: 'Room and bed occupancy metrics.',
                    path: '/hostel-management/reports/occupancy',
                    icon: 'hotel',
                    colorScheme: 'purple',
                    feature: '@hostel/reports/occupancy',
                    action: 'read',
                  },
                  {
                    label: 'Disciplinary Report',
                    slug: 'disciplinary-report',
                    description: 'Overview of disciplinary actions.',
                    path: '/hostel-management/reports/disciplinary',
                    icon: 'gavel',
                    colorScheme: 'red',
                    feature: '@hostel/reports/disciplinary',
                    action: 'read',
                  },
                  {
                    label: 'Asset Inventory Report',
                    slug: 'asset-inventory-report',
                    description: 'Consolidated asset inventory report.',
                    path: '/hostel-management/reports/asset-inventory',
                    icon: 'inventory',
                    colorScheme: 'orange',
                    feature: '@hostel/reports/asset-inventory',
                    action: 'read',
                  },
                  {
                    label: 'Staff Performance Report',
                    slug: 'staff-performance-report',
                    description: 'Analyze staff performance.',
                    path: '/hostel-management/reports/staff-performance',
                    icon: 'analytics',
                    colorScheme: 'teal',
                    feature: '@hostel/reports/staff-performance',
                    action: 'read',
                  },
                  {
                    label: 'Incident Analysis Report',
                    slug: 'incident-analysis-report',
                    description: 'Analyze hostel incidents over time.',
                    path: '/hostel-management/reports/incident-analysis',
                    icon: 'troubleshoot',
                    colorScheme: 'red',
                    feature: '@hostel/reports/incident-analysis',
                    action: 'read',
                  },
                  {
                    ...
                    path: '/hostel-management/reports/audit-logs',
                    icon: 'security',
                    colorScheme: 'blue',
                    feature: '@hostel/reports/audit-logs',
                    action: 'read',
                  },
                  {
                    label: 'Settings',
                    slug: 'settings',
                    description: 'Configure hostel module settings.',
                    path: '/hostel-management/reports/settings',
                    icon: 'settings',
                    colorScheme: 'purple',
                    feature: '@hostel/reports/settings',
                    action: 'write',
                  },
                ],
              },
          ...
          {
            label: 'Student Portal',
            slug: 'hostel-student-portal',
            description: 'Self-service portal for hostel residents.',
            path: '/hostel-management/student',
            icon: 'school',
            colorScheme: 'teal',
            navigationStyle: 'sidebar',
            children: [
              {
                ...
                description:
                  'Overview of room, roommate, gate passes, and mess menu.',
                path: '/hostel-management/student-dashboard',
                icon: 'dashboard',
                colorScheme: 'blue',
                feature: '@hostel/student/dashboard',
                action: 'read',
              },
              {
                label: 'Apply Gate Pass',
                slug: 'student-gate-pass',
                description: 'Request a gate pass for outings.',
                path: '/hostel-management/student-operations/gate-pass-request',
                icon: 'exit_to_app',
                colorScheme: 'green',
                feature: '@hostel/student/gate-pass',
                action: 'write',
              },
              {
                label: 'Request Leave',
                ...
                path: '/hostel-management/student-operations/leave-request',
                icon: 'event_available',
                colorScheme: 'orange',
                feature: '@hostel/student/leave',
                action: 'write',
              },
              {
                label: 'Raise Complaint',
                slug: 'student-complaint',
                description: 'Submit maintenance complaints and track tickets.',
                path: '/hostel-management/maintenance/requests',
                icon: 'build',
                colorScheme: 'red',
                feature: '@hostel/student/complaint',
                action: 'write',
              },
              {
                label: 'Mess Menu',
                slug: 'student-mess-menu',
                description: 'View weekly mess menu schedule.',
                path: '/hostel-management/student-dashboard/mess-menu',
                icon: 'restaurant',
                colorScheme: 'purple',
                feature: '@hostel/student/mess-menu',
                action: 'read',
              },
            ],
          },
