        ...
        children: [
            ...
            children: [
              {
                ...
                path: '/examination-management/exam-type',
                icon: 'assignment',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/exam-cycle',
                icon: 'date_range',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/time-slots',
                icon: 'schedule',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/session-templates',
                icon: 'description',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/centers',
                icon: 'location_on',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/duty-types',
                icon: 'badge',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/admit-card-templates',
            ...
            children: [
              {
                ...
                path: '/examination-management/fees',
                icon: 'receipt',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/late-fees',
                icon: 'warning',
                colorScheme: 'red',
          ...
          },
          {
            ...
            children: [
              ...
              {
                label: 'Student Exam Form',
                description: 'Fill and submit student exam form.',
              ...
              },
              {
                ...
                path: '/examination-management/supplementary-setup',
                icon: 'add_task',
                colorScheme: 'red',
          ...
          {
            label: 'Marks & Results',
            slug: 'examination-marks-results',
            description:
              'Manage marks entry, verification, results and revaluation.',
            path: '/home/sub-menu/examination-marks-results',
            icon: 'grading',
            colorScheme: 'red',
            children: [
              {
                ...
                path: '/examination-management/moderation',
                icon: 'auto_fix_high',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/result-publication',
                icon: 'publish',
                colorScheme: 'red',
              ...
              },
              {
                ...
                path: '/examination-management/grade-cards',
                icon: 'assignment_ind',
                colorScheme: 'red',
