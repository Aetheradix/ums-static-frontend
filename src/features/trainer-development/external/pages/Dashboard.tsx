    ...
    >
      ...
      >
        ...
        <StatCard
          ...
          icon="star"
          colorScheme="orange"
          subtitle="From 120 participants"
        />
        <StatCard
      ...
      >
        <FormCard
          title="Assigned Training Programmes"
          headerAction={
            <button
              type="button"
              onClick={() => navigate(tdmUrls.external.assignedTrainings)}
              style={{
                color: '#3b82f6',
                background: 'none',
                border: 'none',
                ...
                >
                  ...
                  >
                    <i
                      ...
                      style={{ fontSize: '0.6rem', marginRight: 4 }}
                    />
                    {s.date}
                  </span>
                  <span
