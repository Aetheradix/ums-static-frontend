...
export default function CompetenciesPage() {
  const [data] = useState(
    competencyMappings.filter(c => c.employeeId === 'EMP-1042')
  );
          ...
          columns={[
            {
              ...
              cell: item => (
                <span style={{ fontWeight: 600 }}>{item.competency}</span>
              ),
            },
            {
              field: 'currentLevel',
              ...
              cell: item =>
                item.gap > 0 ? (
                  <Button
                    ...
                    variant="primary"
                    label="Find Training"
                    onClick={() => setPopup({ mode: 'find', item })}
                  />
                ) : (
        ...
        {popup.mode === 'find' && (
          ...
          >
            ...
            <p>
              ...
              {popup.mode === 'find' ? popup.item?.competency : ''} will be
              displayed here.
            </p>
          </div>
        )}
