    ...
    >
      <FormCard>
          ...
          <div style={{ width: 250 }}>
            <DropDownList
              ...
              data={[
                ...
                ...departments.map(d => ({ name: d, value: d })),
              ]}
              textField="name"
              optionValue="value"
              value={deptFilter}
        ...
        <GridPanel
              ...
              cell: item => (
                ...
                >
                  ...
                  <i
                    ...
                    style={{ fontSize: '0.625rem', color: '#9ca3af' }}
                  />
                  <div
                    style={{
                      background: '#dbeafe',
            ...
            },
            {
              ...
              cell: item => (
                <span
                  style={{
                    fontWeight: 700,
                    color: item.gap > 0 ? '#ef4444' : '#10b981',
                  }}
                >
            ...
            },
            {
              ...
              cell: item => (
                <Button
                  ...
                  onClick={() => setPopup({ mode: 'assign', item })}
                />
              ),
            },
          ]}
          toolbar={
            <Button
              label="Map New Competency"
              icon="plus"
              variant="primary"
              onClick={() => setPopup({ mode: 'map' })}
            />
          }
          searchBox
        />
      ...
      >
        ...
        {popup.mode === 'assign' && (
          ...
          >
            ...
            <p>
              Assign training to {popup.item?.employeeName} for{' '}
              {popup.item?.competency} gap.
            </p>
          </div>
        )}
      </FormPopup>
