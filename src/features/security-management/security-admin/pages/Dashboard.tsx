...
const HIGH_PRIORITY = incidents.filter(
      ...
      <div className="sms-charts-row">
        ...
        <FormCard title="Incident Status Overview">
          {[
            ...
            {
              label: 'Action Taken',
              count: incidentStats.actionTaken,
              color: '#f97316',
            },
            {
              label: 'Resolved',
              ...
              >
                ...
                >
                  <i
                    ...
                    style={{ color: a.color, fontSize: '0.875rem' }}
                  />
                </span>
                {a.label}
              </button>
        ...
        <FormCard title="High Priority Incidents">
          ...
          <button
            ...
            onClick={() => navigate(smsUrls.securityAdmin.incidents)}
          >
            View All Incidents →
          </button>
        </FormCard>
          ...
          <tbody>
            {incidents.slice(0, 6).map(inc => (
              <tr key={inc.id}>
                ...
                <td>
                  {inc.assignedTo || (
                    <em style={{ color: '#9ca3af' }}>Not Assigned</em>
                  )}
                </td>
                <td>
                  <span
