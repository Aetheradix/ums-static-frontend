      ...
      {myIncidents.length === 0 ? (
        <FormCard>
          <div style={{ textAlign: 'center', padding: '3rem 1rem' }}>
            ...
            <p style={{ fontSize: '1rem', fontWeight: 600, color: '#111827', marginBottom: '0.5rem' }}>No Incidents Reported</p>
            <p style={{ fontSize: '0.813rem', color: '#6b7280' }}>You haven't reported any security incidents yet. Stay safe!</p>
          </div>
        </FormCard>
      ) : (
          ...
          {myIncidents.map(inc => (
            <FormCard key={inc.id}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
                    <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#111827' }}>{inc.incidentId}</h3>
                  ...
                  <p style={{ fontSize: '0.688rem', color: '#9ca3af', marginTop: 4 }}>
              ...
              <div style={{ background: '#f9fafb', borderRadius: 8, padding: '0.75rem' }}>
                <p style={{ fontSize: '0.688rem', fontWeight: 600, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem' }}>Incident Progress</p>
        ...
        >
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '0.75rem' }}>
            {[
              ...
              { label: 'Assigned To', value: popup.item.assignedTo || 'Pending Assignment' },
            ].map(f => (
              <div key={f.label}>
          ...
          <p style={{ fontSize: '0.813rem', fontWeight: 600, marginBottom: '0.75rem', color: '#374151' }}>Case Timeline</p>
