    ...
    >
      ...
      <div className="sms-dashboard-stats">
        ...
        <StatCard
          ...
          value={helplines.filter(h => h.status === 'Active').length}
          icon="phone_in_talk"
          colorScheme="red"
      ...
      <div className="sms-charts-row">
        ...
        <FormCard title="Emergency Helplines">
                ...
                <div key={h.id} className="sms-list-item">
                  ...
                  <div className="sms-list-text">
                    ...
                    <span className="sms-list-sub">
                      {h.contactNumber} · {h.availability}
                    </span>
                  </div>
                </div>
              ))}
          ...
          <button
            type="button"
            className="sms-view-all-btn"
            onClick={() => navigate(smsUrls.employee.helplines)}
          >
            View All Helplines →
          </button>
        </FormCard>
        ...
        <FormCard title="Upcoming Programs">
          ...
          <button
            type="button"
            className="sms-view-all-btn"
            onClick={() => navigate(smsUrls.employee.awareness)}
          >
            View All Programs →
          </button>
        </FormCard>
          ...
          {[
            ...
            >
              <i
                ...
                style={{ fontSize: '1.5rem', color: a.color }}
              />
              <span
                style={{
                  fontSize: '0.75rem',
