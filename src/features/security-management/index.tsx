...
export default function SecurityManagementRoutes() {
  return (
    <Routes>
      ...
      {/* Masters */}
      <Route path="super-admin/masters/incident-category" element={<IncidentCategoryMaster />} />
      <Route path="super-admin/masters/incident-type" element={<IncidentTypeMaster />} />
      ...
      <Route path="super-admin/masters/department-mapping" element={<DepartmentMapping />} />
      <Route path="super-admin/masters/emergency-contact-type" element={<EmergencyContactType />} />
      {/* Operations */}
      <Route path="super-admin/helpline" element={<HelplineManagement />} />
      <Route path="super-admin/guidelines" element={<GuidelinesManagement />} />
      <Route path="super-admin/awareness" element={<AwarenessProgramManagement />} />
      <Route path="super-admin/incidents" element={<SuperAdminIncidentManagement />} />
      <Route path="super-admin/reports" element={<SuperAdminReports />} />
      <Route path="super-admin/settings" element={<SuperAdminSettings />} />

      {/* ── Security Admin ── */}
      <Route path="security-admin" element={<SecurityAdminPortalPage />} />
      <Route path="security-admin/dashboard" element={<SecurityAdminDashboard />} />
      <Route path="security-admin/incidents" element={<SecurityAdminIncidentManagement />} />
      <Route path="security-admin/helpline" element={<SecurityAdminHelpline />} />
      <Route path="security-admin/guidelines" element={<SecurityAdminGuidelines />} />
      <Route path="security-admin/awareness" element={<SecurityAdminAwarenessPrograms />} />
      ...
      <Route path="officer/assigned-incidents" element={<AssignedIncidents />} />

      {/* ── Employee ── */}
      <Route path="employee" element={<EmployeePortalPage />} />
      <Route path="employee/dashboard" element={<EmployeeDashboard />} />
      <Route path="employee/report-incident" element={<EmployeeReportIncident />} />
      ...
      <Route path="employee/awareness" element={<EmployeeAwarenessPrograms />} />
