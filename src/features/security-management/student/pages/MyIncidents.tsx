...
export default function StudentMyIncidents() {
  ...
  return (
    <FormPage
      title="My Incidents"
      description="Track your reported incidents with real-time updates."
      breadcrumbs={[
        { label: 'Home', to: '/home' },
        ...
        <FormCard>
          <div style={{ textAlign: 'center', padding: '3rem' }}>
            ...
            <p style={{ fontSize: '0.813rem', color: '#6b7280' }}>
              Stay safe! No incidents have been filed from your account.
            </p>
          </div>
        </FormCard>
      ) : (
        ...
        >
          ...
          >
            {[
              ...
              {
                label: 'Assigned To',
                value: popup.item.assignedTo || 'Pending',
              },
            ].map(f => (
              <div key={f.label}>
                <p
