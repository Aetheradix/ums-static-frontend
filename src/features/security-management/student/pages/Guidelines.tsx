...
export default function StudentGuidelines() {
  ...
  return (
    <FormPage
      ...
      description="University safety guidelines applicable for students."
      breadcrumbs={[
        { label: 'Home', to: '/home' },
      ...
      >
        {guidelines
          .filter(
            g =>
              g.status === 'Active' &&
              (g.applicableFor === 'Student' || g.applicableFor === 'All')
          )
          .map(g => {
            ...
            return (
              ...
              >
                ...
                >
                  {g.category} · Effective: {g.effectiveDate}
                </p>
                <p
                  style={{
                    fontSize: '0.75rem',
                ...
                {g.pdfUrl && (
                  ...
                  >
                    <i className="pi pi-file-pdf" /> PDF Available
                  </span>
                )}
              </div>
            );
