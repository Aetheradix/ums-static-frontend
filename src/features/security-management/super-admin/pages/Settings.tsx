      ...
      <FormCard>
        ...
        <div style={{ marginTop: '1.25rem' }}>
          {activeTab === 'general' && (
            <FormGrid columns={2}>
              ...
              />
              <TextBox
                label="Security Control Room Email"
                value={contactEmail}
          ...
          {activeTab === 'workflow' && (
            <FormGrid columns={2}>
              ...
              />
              <TextBox
                label="SLA Hours (High Priority)"
                value="4"
                onChange={() => {}}
              />
              <TextBox
                label="SLA Hours (Critical Priority)"
                value="1"
                onChange={() => {}}
              />
              <TextBox
              ...
              {[
                {
                  role: 'Super Admin',
                  permissions:
                    'Full Access — Masters, Reports, Settings, Incidents',
                },
                {
                  role: 'Security Admin',
                  permissions:
                    'Incidents, Helplines, Guidelines, Awareness, Reports (No Masters)',
                },
                {
                  role: 'Security Officer',
                  permissions:
                    'Assigned Incidents Only — View, Investigate, Resolve, Close',
                },
                {
                  role: 'Employee',
                  permissions:
                    'Report Incident, View Own Incidents, Helplines, Guidelines, Awareness',
                },
                {
                  role: 'Student',
                  permissions:
                  ...
                  <Button
                    ...
                    onClick={() =>
                      ToastService.success(
                        'Access control is managed by system administrators.'
                      )
                    }
                  />
                </div>
        ...
        <div className="flex justify-end gap-3 mt-4">
          <Button
            ...
            variant="outlined"
            icon="refresh"
            onClick={() => ToastService.success('Settings reset to defaults.')}
          />
          <Button
            label="Save Settings"
            variant="primary"
            icon="save"
            onClick={() => ToastService.success('Settings saved successfully.')}
          />
        </div>
      </FormCard>
    </FormPage>
