...
export default function SportsManagement() {
  return (
    <Routes>
      ...
      <Route
        index
        element={<Navigate to="/home/sub-menu/sports-management" replace />}
      />

      {/* STUDENT */}
      <Route
        path="student"
        element={<Navigate to="/home/sub-menu/sports-student" replace />}
      />
      <Route
      ...
      <Route
        path="admin"
        element={<Navigate to="/home/sub-menu/sports-admin" replace />}
      />
      ...
      <Route
        path="master"
        element={<Navigate to="/home/sub-menu/sports-master" replace />}
      />
