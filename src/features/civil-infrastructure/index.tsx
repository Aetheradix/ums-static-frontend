...
export default function CivilInfrastructure() {
  return (
    <Routes>
      ...
      <Route path="admin/work-categorization" element={<WorkCategorization />} />
      ...
      <Route path="admin/agency-verification" element={<AgencyVerification />} />
      <Route path="admin/work-order-sign"     element={<WorkOrderSign />} />
      <Route path="admin/eot-requests"        element={<AdminEOTRequest />} />
      <Route path="admin/completion-certificate" element={<CompletionCertificate />} />
      ...
      <Route path="engineer/technical-planning" element={<TechnicalPlanning />} />
      ...
      <Route path="engineer/progress-monitoring" element={<ProgressMonitoring />} />
      <Route path="engineer/quality-testing"    element={<QualityTesting />} />
      <Route path="engineer/e-measurement-book" element={<EMeasurementBook />} />
      ...
      <Route path="finance/final-bill-settlement" element={<FinalBillSettlement />} />
