...
export default function SORMaster() {
  ...
  return (
    ...
    >
      ...
      >
        <strong>SOR Integration Rule:</strong> All rates are locked from the
        State Govt SOR 2025-26. Engineers can only SELECT items — they cannot
        modify rates. These locked rates flow through to BOQ → MB → Bill →
        Payment.
      </div>
