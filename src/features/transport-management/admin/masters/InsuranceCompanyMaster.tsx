...
export default function InsuranceCompanyMaster() {
  ...
  return (
    <FormPage
      ...
      description="Manage insurance companies for vehicles."
      breadcrumbs={[
        { label: 'Home', to: '/home' },
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <FormCard title="Add / Edit Company">
            <FormGrid columns={1}>
              <TextBox
                ...
                placeholder="Ex: LIC, Bajaj Allianz"
                required
              />
              <TextBox
        ...
        <div className="md:col-span-2">
          <FormCard title="Insurance Companies List">
              ...
              <table className="w-full text-sm text-left border rounded-lg">
                ...
                <tbody>
                  <tr className="border-b bg-white hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 font-medium">Bajaj Allianz</td>
