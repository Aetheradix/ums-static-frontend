...
export default function FuelTypeMaster() {
  ...
  return (
    <FormPage
      ...
      description="Manage different types of fuels used by vehicles."
      breadcrumbs={[
        { label: 'Home', to: '/home' },
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-1">
          <FormCard title="Add / Edit Fuel Type">
            <FormGrid columns={1}>
              <TextBox
                label="Fuel Type"
                value={form.fuelType}
                onChange={v => handleChange('fuelType', v)}
                placeholder="Ex: Diesel, Petrol, CNG"
                required
              />
              <TextBox
                label="Description"
        ...
        <div className="md:col-span-2">
          <FormCard title="Fuel Types List">
              ...
              <table className="w-full text-sm text-left border rounded-lg">
                ...
                <tbody>
                  <tr className="border-b bg-white hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 font-medium">Diesel</td>
                    <td className="px-4 py-3">Standard Diesel</td>
                  ...
                  <tr className="border-b bg-white hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 font-medium">CNG</td>
                    <td className="px-4 py-3">Compressed Natural Gas</td>
                    <td className="px-4 py-3">
                      <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs">
                        Active
                      </span>
