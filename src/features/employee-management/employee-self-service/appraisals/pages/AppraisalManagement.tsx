...
export default function AppraisalManagement() {
  ...
  const onSubmit = async (data: any) => {
    ...
    const newSAR: AppraisalRecord = {
      ...
      period: data.period || 'April 2025 - March 2026',
      reviewer: data.reviewer || 'Dr. Robert Carter (HOD)',
      selfRating: Number(data.selfRating || 4),
      reviewerRating: 'Pending',
      status: 'Submitted',
    };
  ...
  return (
    ...
    >
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <FormGrid columns={3}>
            ...
            <DropDownList
              {...register('selfRating')}
              label="Self Rating"
              placeholder="Select Self Rating"
              data={ratings}
              textField="name"
              valueField="id"
              required
      ...
      <FormCard title="Previous Appraisal Submissions" icon="folder-open">
