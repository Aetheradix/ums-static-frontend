...
const nodesData = [
  {
    ...
    icon: BookOpen,
    desc: 'Core syllabus and programs.',
    color: '#ffedd5',
    textColor: '#ea580c',
    gradStart: '#ffedd5',
    gradEnd: '#fecaca',
  },
  {
    ...
    icon: Monitor,
    desc: 'Student portal and services.',
    color: '#e0e7ff',
    textColor: '#4f46e5',
    gradStart: '#e0e7ff',
    gradEnd: '#fbcfe8',
  },
  {
    name: 'Governance',
    icon: Shield,
    desc: 'Policies, rules and compliance.',
    color: '#dcfce7',
    textColor: '#16a34a',
    gradStart: '#dcfce7',
    gradEnd: '#ccfbf1',
  },
  {
    ...
    icon: FileText,
    desc: 'Scheduling, grading and results.',
    color: '#fef9c3',
    textColor: '#ca8a04',
    gradStart: '#fef9c3',
    gradEnd: '#fed7aa',
  },
  {
    name: 'Finance',
    icon: IndianRupee,
    desc: 'Fees, billing and accounts.',
    color: '#f3e8ff',
    textColor: '#9333ea',
    gradStart: '#f3e8ff',
    gradEnd: '#fbcfe8',
  },
  {
    ...
    icon: Globe,
    desc: 'Hostels, transport and library.',
    color: '#d1fae5',
    textColor: '#059669',
    gradStart: '#d1fae5',
    gradEnd: '#e0f2fe',
  },
  {
    name: 'HRMS',
    icon: Users,
    desc: 'Staff directory and payroll.',
    color: '#dbeafe',
    textColor: '#2563eb',
    gradStart: '#dbeafe',
    gradEnd: '#e0e7ff',
  },
  {
    ...
    icon: Building,
    desc: 'Classrooms, labs and facilities.',
    color: '#cffafe',
    textColor: '#0891b2',
    gradStart: '#cffafe',
    gradEnd: '#dcfce7',
