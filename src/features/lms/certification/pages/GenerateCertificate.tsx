              ...
              cell: (item: any) =>
                item.status === 'Pending' ? (
                  <Button
                    ...
                    size="small"
                    variant="primary"
                    onClick={() => setPopup({ mode: 'generate', item })}
                  />
                ) : (
                  <Button
                    label="View"
      ...
      >
        <div className="grid grid-cols-1 gap-4">
          <div className="bg-gray-50 p-3 rounded">
            ...
            <div>
              <strong>Course:</strong> {popup.item?.course}
            </div>
            <div>
              <strong>Completion Date:</strong> {popup.item?.completionDate}
            </div>
          </div>
          ...
          {popup.mode === 'generate' ? (
            <div className="mt-4 border-t pt-4">
              ...
              <FileUpload
                label="Select Image File (.png, .jpg)"
                onChange={() => {}}
              />
            </div>
          ) : (
            <div className="mt-4 border-t pt-4">
              <div className="border-8 border-double border-gray-300 p-8 text-center bg-white shadow-lg relative">
                ...
                <h3 className="text-4xl font-serif text-blue-600 font-bold mb-6">
                  {popup.item?.student}
                </h3>
