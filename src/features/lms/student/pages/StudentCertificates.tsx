                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xxs text-gray-500 mt-1">
                        Issued on {cert.issueDate} • Credential ID:{' '}
                        {cert.credentialId}
                      </p>
                    </div>
                  </div>
          ...
          <FormCard title="Completed Courses History">
            <div className="space-y-3">
              {[
                ...
                {
                  name: 'Introduction to Advanced Programming in C++',
                  code: 'BTECH-CS',
                  date: 'May 12, 2026',
                  grade: 'A',
                },
                ...
                >
                  ...
                  <span className="px-2 py-0.5 rounded text-xxs font-bold bg-green-150 text-green-700">
                    Completed
                  </span>
                </div>
              ))}
        ...
        <FormCard title="Achievement Badges Collection">
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              {
                title: 'Code Warrior',
                desc: 'Completed all C++ lab assignments',
                icon: 'code',
                color: 'text-indigo-600 bg-indigo-50 border-indigo-200',
              },
              {
                title: 'Attendance Star',
                desc: 'Maintained 85%+ attendance rate',
                icon: 'schedule',
      ...
      {viewingCert && (
        ...
        >
          <div className="flex flex-col items-center">
            ...
            >
              {/* Corner Ornaments */}
              <div className="absolute top-2 left-2 text-amber-700">
                <Icon name="filter_vintage" />
              </div>
              <div className="absolute top-2 right-2 text-amber-700">
                <Icon name="filter_vintage" />
              </div>
              <div className="absolute bottom-2 left-2 text-amber-700">
                <Icon name="filter_vintage" />
              </div>
              <div className="absolute bottom-2 right-2 text-amber-700">
                <Icon name="filter_vintage" />
              </div>

              <h2
                className="text-amber-800 font-bold uppercase tracking-widest text-lg"
              ...
              <div className="mt-8 grid grid-cols-2 gap-4 text-left border-t border-amber-100 pt-6">
                <div>
                  <p className="text-xxs text-gray-400 uppercase">
                    Verification Hash
                  </p>
                  <p className="text-xxs font-mono text-gray-700 font-semibold">
                    {viewingCert.credentialId}
                  </p>
                  <p className="text-xxs text-gray-400 uppercase mt-2">
                    Issue Date
                  </p>
                  <p className="text-xxs text-gray-700 font-bold">
                ...
                <div className="text-right flex flex-col justify-end items-end">
                  ...
                  <p className="text-xxs text-gray-400 uppercase mt-1">
