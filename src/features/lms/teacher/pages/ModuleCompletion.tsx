...
const MOCK_MODULE_COMPLETION = [
  { id: 1, course: 'B.Tech Computer Science', moduleName: 'Programming Basics', section: 'Section A', completionRate: '95%', status: 'Completed' },
  { id: 2, course: 'B.Tech Computer Science', moduleName: 'Database Management Systems', section: 'Section A', completionRate: '60%', status: 'In Progress' },
  { id: 3, course: 'B.Tech Computer Science', moduleName: 'Data Structures & Algorithms', section: 'Section A', completionRate: '0%', status: 'Not Started' },
];
