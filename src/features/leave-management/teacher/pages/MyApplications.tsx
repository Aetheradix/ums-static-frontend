...
const teacherApps: LeaveApplication[] = [
  ...
  {
    id: 'T001', appNo: 'LMS-2024-T001', applicant: MY_TEACHER, role: 'Teacher',
    department: 'Computer Science', leaveType: 'Casual Leave',
    fromDate: '2024-05-15', toDate: '2024-05-16', days: 2, appliedDate: '2024-05-13',
    currentApprover: 'Dr. Rajesh Kumar', status: 'Approved',
    reason: 'Personal work', remarks: 'Approved.',
  },
  {
    id: 'T002', appNo: 'LMS-2024-T002', applicant: MY_TEACHER, role: 'Teacher',
    department: 'Computer Science', leaveType: 'Medical Leave',
    fromDate: '2024-04-08', toDate: '2024-04-10', days: 3, appliedDate: '2024-04-07',
    currentApprover: 'Dr. Rajesh Kumar', status: 'Approved',
    reason: 'Fever and cold', remarks: 'Get well soon.',
  },
  {
    id: 'T003', appNo: 'LMS-2024-T003', applicant: MY_TEACHER, role: 'Teacher',
    department: 'Computer Science', leaveType: 'Earned Leave',
    fromDate: '2024-03-25', toDate: '2024-03-28', days: 4, appliedDate: '2024-03-20',
    currentApprover: 'Dr. Rajesh Kumar', status: 'Rejected',
    reason: 'Family vacation', remarks: 'Critical exam period. Cannot approve.',
  },
];

const buildTimeline = (app: LeaveApplication): TimelineStep[] => {
  const steps: TimelineStep[] = [
    { actor: app.applicant, role: 'Teacher', action: 'submitted', date: app.appliedDate, remarks: app.reason },
  ];
  if (app.status === 'Approved') {
    steps.push({ actor: app.currentApprover, role: 'HOD', action: 'approved', date: app.fromDate, remarks: app.remarks });
  } else if (app.status === 'Rejected') {
    steps.push({ actor: app.currentApprover, role: 'HOD', action: 'rejected', date: app.fromDate, remarks: app.remarks });
  } else {
    steps.push({ actor: app.currentApprover, role: 'HOD', action: 'pending', date: '—' });
  }
  return steps;
};
...
export default function MyApplications() {
  ...
  const handleWithdraw = (item: LeaveApplication) => {
    setData(prev => prev.map(d => d.id === item.id ? { ...d, status: 'Withdrawn' } : d));
            ...
            },
            {
              ...
              cell: (item: LeaveApplication) => (
                <div style={{ display: 'flex', gap: '0.375rem' }}>
                  ...
                  {item.status === 'Pending' && (
                    <Button size="small" label="Withdraw" icon="times" variant="danger"
      ...
      {popup.mode === 'view' && (
        ...
        >
          ...
          <div style={{ padding: '0.75rem', background: '#f9fafb', borderRadius: 8, marginBottom: '1.25rem' }}>
            <p style={{ fontSize: '0.688rem', color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 4 }}>Reason</p>
