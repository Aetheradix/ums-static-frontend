...
export default function TeacherBiometric() {
  return (
    <FormPage
      ...
      description="Your biometric punch history, working hours and attendance status."
      breadcrumbs={[
        { label: 'Home', to: '/home' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <FormCard title="June 2024 Summary">
          {[
            ...
            { label: 'Average Punch In', value: '09:02 AM' },
            { label: 'Average Punch Out', value: '05:12 PM' },
            { label: 'Average Hours', value: '8h 10m' },
