...
const UPCOMING_EVENTS = [
  {
    date: '28 Jun 2024',
    label: 'Internal Assessment — Sem 6',
    type: 'exam',
    color: '#7c3aed',
  },
  {
    date: '15 Jul 2024',
    label: 'Mid Semester Break Begins',
    type: 'vacation',
    color: '#b45309',
  },
  {
  ...
  {
    date: '2 Sep 2024',
    label: 'Sem 7 Registration Deadline',
    type: 'working',
    color: '#15803d',
  },
  {
    date: '20 Sep 2024',
    label: 'End Semester Exams Begin',
    type: 'exam',
    color: '#7c3aed',
  },
  {
              ...
              {LEGEND_ITEMS.map(item => (
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: '0.813rem',
                      color: selectedType === item.type ? '#1d4ed8' : '#374151',
